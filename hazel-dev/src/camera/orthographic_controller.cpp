...
{
    OrthographicController::OrthographicController(float aspect_ratio, bool rotation)
    ...
    Orthographic &OrthographicController::get_camera()
    {
        return this->camera;
    }
    ...
    void OrthographicController::on_event(hazel::event::Event &e)
    {
        ...
        dispatcher.dispatch<hazel::event::MouseScrollEvent>(EVENT_BIND_METHOD_1(OrthographicController::on_mouse_scroll));
        dispatcher.dispatch<hazel::event::WindowResizeEvent>(EVENT_BIND_METHOD_1(OrthographicController::on_window_resize));
    }

    bool OrthographicController::on_mouse_scroll(hazel::event::MouseScrollEvent &e)
    {
    ...
    bool OrthographicController::on_window_resize(hazel::event::WindowResizeEvent &e)
    {
