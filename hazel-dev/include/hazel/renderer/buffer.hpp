...
struct BufferLayoutElement {
  ...
  BufferLayoutElement(ShaderDataType type, const std::string name,
...
public:
  ...
  const std::vector<BufferLayoutElement> &get_elements() const {
...
public:
  ...
  static hazel::core::Ref<VertexBuffer> create(float *vertices, size_t size);
...
public:
  ...
  static hazel::core::Ref<IndexBuffer> create(unsigned int *indices,
                                              size_t size);
