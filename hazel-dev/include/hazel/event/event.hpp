...
#define EVENT_TYPE_METHODS(type)                                               \
  ...
  virtual EventType get_event_type() const override {                          \
    return this->get_static_event_type();                                      \
  }                                                                            \
  virtual const char *get_name() const override { return #type; }

#define EVENT_TYPE_CATEGORY_METHODS(category)                                  \
  virtual unsigned int get_event_type_categories() const override {            \
    return category;                                                           \
  }

#define EventTypeCategorySet1(a) static_cast<unsigned int>(a)
#define EventTypeCategorySet2(a, b)                                            \
  static_cast<unsigned int>(a) | static_cast<unsigned int>(b)
#define EventTypeCategorySet3(a, b, c)                                         \
  static_cast<unsigned int>(a) | static_cast<unsigned int>(b) |                \
