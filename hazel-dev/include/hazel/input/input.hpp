...
namespace hazel::input
{
    ...
    {
    public:
        static bool is_key_pressed(unsigned int key_code) { return instance->is_key_pressed_impl(key_code); }

        static bool is_mouse_button_pressed(unsigned int button) { return instance->is_mouse_button_pressed_impl(button); }
